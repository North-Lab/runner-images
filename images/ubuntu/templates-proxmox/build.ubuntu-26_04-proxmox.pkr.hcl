# Mirrors images/ubuntu/templates/build.ubuntu-26_04.pkr.hcl provisioners so the
# Proxmox template installs the same runner-image software as the Azure path.
# Azure-only cleanup (waagent deprovision) is replaced at the end.
build {
